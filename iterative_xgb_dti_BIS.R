...
for (runtimes in 1:5) {
  ...
  important_pdf = paste0("./figures/importance_BIS_round",runtimes,".pdf")
  pdf(file=important_pdf,width=20,height=12)
  par(mfrow=c(2,5))
  ...
  file_path = paste0("./xgb_importance_BIS/round",runtimes,".csv")
